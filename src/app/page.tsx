...
export default function LandingPage() {
  ...
  // Calculate card style based on its position in the stack
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div className="lg:sticky lg:top-32">
              ...
              <div className="mb-10 animate-fade-in-up pl-6">
                ...
                <p className="text-2xl lg:text-3xl text-slate-500 mt-2">
                  Product & Strategy
                </p>
              </div>
                ...
                <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-base text-slate-600 mt-1">Product Manager Intern</p>
                    </div>
                ...
                <div className="bg-sage-green/5 rounded-2xl p-6 border border-sage-green/20">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm text-slate-600">Strategy Summer Associate</span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm text-slate-600">Founder ($500k revenue)</span>
                    </div>
                  </div>
                </div>

                {/* Projects CTA */}
                <div className="hidden lg:flex items-center gap-2 text-slate-500 pt-4 pl-2">
            ...
            <div>
              ...
              <div className="hidden lg:block animate-fade-in-up delay-300">
                ...
                <div className="flex justify-center items-center gap-6 mt-8">
                  <button
                    onClick={goToPrev}
                    className="w-10 h-10 rounded-full border-2 border-slate-300 flex items-center justify-center hover:border-sage-green hover:text-sage-green transition-colors text-slate-400"
